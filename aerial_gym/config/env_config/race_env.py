from aerial_gym.config.asset_config.env_object_config import gate
...
class RaceEnvCfg:
    class env:
        ...
        use_warp = False
        e_s = 20.0
        lower_bound_min = [-e_s, -e_s, 0]  # lower bound for the environment space
        lower_bound_max = [-e_s, -e_s, 0]  # lower bound for the environment space
        upper_bound_min = [e_s, e_s, 2 * e_s]  # upper bound for the environment space
        upper_bound_max = [e_s, e_s, 2 * e_s]  # upper bound for the environment space
