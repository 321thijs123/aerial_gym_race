...
from aerial_gym.config.robot_config.dragon_config import DragonCfg, DragonWithCameraCfg, DragonExactCfg
...
robot_registry.register("dragon", BaseMultirotor, DragonCfg)
robot_registry.register("dragon_with_camera", BaseMultirotor, DragonWithCameraCfg)
robot_registry.register("dragon_exact", BaseMultirotor, DragonExactCfg)
